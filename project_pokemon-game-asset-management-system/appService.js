...
// Database configuration setup. Ensure .env file has the required database credentials.
const dbConfig = {
...
// Modify these functions, especially the SQL queries, based on project's requirements and design.
